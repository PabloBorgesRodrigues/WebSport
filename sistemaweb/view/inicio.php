      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="../view/inicio.php">Inicio</a>
            </li>
            ...
            <?php if(!isset($_SESSION['logado'])): ?>
              <a class="nav-link text-primary" href="../view/projeto.php">Cadastrar</a>
              <?php endif;?>
            </li>
            ...
            <div class="d-flex">
              <?php if(isset($_SESSION['logado'])):  ?>
              <a href="../view/atualizarDados.php" class="btn btn-success">Atualizar Dados</a>
              <?php endif; ?>
            </div>             
           <div class="d-flex">
           <?php if(isset($_SESSION['logado'])):  ?>
            <a href="../models/sair.php" class="btn btn-danger">Sair</a>
            <?php endif; ?>
          </div>
