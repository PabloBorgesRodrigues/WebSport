    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li> <?php if(!empty($logado)){echo "<h1> Bem vindo <u>$nome</u></h1>";}?></li>
             <!--  -->
          </ul>
          </form>
        </div>
        ...
        <ul class="produtos">
          <h2>Camisas</h2>
              <li>
                ...
                <p class="produto-descricao">Camisa Corinthians I</p>
                <p class="produto-preco">R$ 349,99</p>                     
              </li>
              <li>
                <h3>Palmeiras</h3> <br>                
                <img src="../sistemaweb/assets/images/palmeiras.png" class="img-shop">
                <p class="produto-descricao">Camisa Palmeiras I</p>
                <p class="produto-preco">R$ 369,90</p>        
              </li>
              <li>
                <h3>São Paulo</h3> <br>            
                <img src="../sistemaweb/assets/images/saopaulo.png" class="img-shop">
                <p class="produto-descricao">Camisa São Paulo I</p>
                <p class="produto-preco">R$ 349,99</p>          
              </li>
              <li>
                <h3>Santos</h3> <br>           
                <img src="../sistemaweb/assets/images/santos.png" class="img-shop">
