  ...
  <body>
        ...
        <?php 
                if(isset($_POST['btn_submit'])){
                  ...
                  //header('Location: atualizarDados.php'); //Nao esta funcionado verificar depois

                  echo "<script>console.log('Dados recebidos: Nome - $nome, Email - $email');</script>";

                   if(!empty($_POST['cli_id'])){ //senao estiver vazio mais confirmar ///foi trocado nao esta igual o padrao
    ...
    <main> 
      <div class="container-sm p-5 top-50 position-absolute start-50 translate-middle" id="form-container">
            <form method="POST"> 
              ...
              <input type="hidden" name="cli_id" value= "<?php echo $id;//if(isset($res)){echo $res['id'];} ?>" /> 
